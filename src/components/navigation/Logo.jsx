...
const Logo = memo(({ className }) => {
  ...
  return (
    <>
      <div
        className={`group flex items-center cursor-pointer transition-colors sm:hidden ${className}`}
      >
        <svg
          width='39'
          height='36'
      ...
      <div className='hidden cursor-pointer w-[18px] h-[18px] sm:block' onClick={toggleSidebar}>
        <svg
          width='18'
          height='14'
          viewBox='0 0 18 14'
        ...
        >
          <path
            d='M0 14H18V11.7895H0V14ZM0 8.10526H18V5.89474H0V8.10526ZM0 0V2.21053H18V0H0Z'
            fill='#11142D'
          />
        </svg>
      </div>
